 ...
 */
final class Version20250216210608 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON categorie');
        $this->addSql('ALTER TABLE categorie ADD id INT NOT NULL, DROP saison_de_recolte, DROP temperature_ideale');
