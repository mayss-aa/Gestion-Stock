...
class Ressource
{
    ...
    #[ORM\Column]
    #[Assert\NotBlank(message: "Champ ne peut pas être vide")]
    #[Assert\GreaterThan(value: 0, message: "nombre doit être positif")]
    ...
    #[ORM\Column(type: Types::DATE_MUTABLE, nullable: false)]  // ✅ Toujours requis (Not Null)
    ...
    {
        if ($this->date_expiration_ressource) {  // ✅ Suppression de la contrainte sur `date_ajout_ressource`
            if ($this->date_ajout_ressource && $this->date_ajout_ressource > $this->date_expiration_ressource) {
